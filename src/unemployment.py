...
df_filtered = df.loc[args.start_date:args.end_date]
create_plot("Unemployment Rate", "Percentage %", df_filtered, args.start_date, args.end_date)

df_transposed = df.T
generate_percentage_change_table(df_transposed, args.start_date, args.end_date)
